...
# Create Rooms
Room.create!(hotel: hotel1, no_of_people: 2, price: 200.00, active: true, category: 'Deluxe')
Room.create!(hotel: hotel2, no_of_people: 2, price: 80.00, active: true, category: 'Standard')
